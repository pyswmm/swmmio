...
def run_swmm_engine(inp_folder):
    ...
    if not m.rpt:
        ...
        with open (logfile, 'a') as f:
            ...
            reporting.generate_figures(baseline_model, m, su.d68d70)
    ...
    if not os.path.exists(os.path.join(wd, 'img')):
        #there are not reporting figures, so lets make some
        reporting.generate_figures(baseline_model, m, su.d68d70)
        with open (logfile, 'a') as f:
                f.write('Generated report figures: {}\n'.format(m.rpt.filePath))
